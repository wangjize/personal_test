function msg = TAF_CAN_new(msgname,type)
  if(255==type)
  msg = struct;
  msg.num=57;
  msg.list= cell(1, msg.num);
  msg.list{1}='VECTOR__INDEPENDENT_SIG_MSG';
  msg.list{2}='CAN_Double0';
  msg.list{3}='CAN_Single0';
  msg.list{4}='CAN_48Bit';
  msg.list{5}='CAN_64Bits';
  msg.list{6}='CAN_Double';
  msg.list{7}='CAN_Single';
  msg.list{8}='CAN0x0';
  msg.list{9}='CAN0x0x';
  msg.list{10}='CAN0x1ffffffb';
  msg.list{11}='CAN0x7fb';
  msg.list{12}='CAN0x1ffffffc';
  msg.list{13}='CAN0x7fc';
  msg.list{14}='CAN0x7fd';
  msg.list{15}='CAN0x1ffffffd';
  msg.list{16}='CAN0x7fe';
  msg.list{17}='CAN0x1ffffffe';
  msg.list{18}='CAN0x1fffffff';
  msg.list{19}='CAN0x7ff';
  msg.list{20}='CAN0x410x';
  msg.list{21}='CAN0x409x';
  msg.list{22}='CAN0x408x';
  msg.list{23}='CAN0x407x';
  msg.list{24}='CAN0x406x';
  msg.list{25}='CAN0x405x';
  msg.list{26}='CAN0x404x';
  msg.list{27}='CAN0x403x';
  msg.list{28}='CAN0x402x';
  msg.list{29}='CAN0x401x';
  msg.list{30}='CAN0x410';
  msg.list{31}='CAN0x409';
  msg.list{32}='CAN0x408';
  msg.list{33}='CAN0x407';
  msg.list{34}='CAN0x406';
  msg.list{35}='CAN0x405';
  msg.list{36}='CAN0x404';
  msg.list{37}='CAN0x403';
  msg.list{38}='CAN0x402';
  msg.list{39}='CAN0x401';
  msg.list{40}='M_UI09';
  msg.list{41}='M_UI08';
  msg.list{42}='M_UI07';
  msg.list{43}='M_UI06';
