function msg = Test_SM(msgname,type)
  if(255==type)
  msg = struct;
  msg.num=13;
  ...
  msg.list{1}='Test_S_3';
  msg.list{2}='Test_S_2';
  msg.list{3}='HCU_COMMAND';
  msg.list{4}='HCU_BMS_0';
  msg.list{5}='BMS_HCU_3';
  msg.list{6}='BMS_HCU_2';
  msg.list{7}='BMS_HCU_1';
  msg.list{8}='BMS_HCU_0';
  msg.list{9}='MCU_STATUS_4';
  msg.list{10}='MCU_STATUS_5';
  msg.list{11}='MCU_STATUS_2';
  msg.list{12}='MCU_STATUS_3';
  msg.list{13}='MCU_STATUS_1';
  else 
  msg = struct;
  switch msgname 
%%
%Network Node:Vector__XXX
%Message Name:Test_S_3
%Message Number:1
case 'Test_S_3'
    ECOCAN.Test_S_3 = struct;
    ECOCAN.Test_S_3 .name = 'Test_S_3';
    ECOCAN.Test_S_3.description = 'Test_S_3';
    ECOCAN.Test_S_3.protocol  = 'ECOCAN';
    ECOCAN.Test_S_3.id = hex2dec('3001');
    ECOCAN.Test_S_3.idext = 'EXTENDED';
    ECOCAN.Test_S_3.payload_size =8;
    ECOCAN.Test_S_3.interval =-1;

    ECOCAN.Test_S_3.fields{1}.name = 'Test_U82';
    ECOCAN.Test_S_3.fields{1}.units = '';
    ECOCAN.Test_S_3.fields{1}.start_bit = 40;
    ECOCAN.Test_S_3.fields{1}.bit_length = 8;
    ECOCAN.Test_S_3.fields{1}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.Test_S_3.fields{1}.data_type = 'UNSIGNED';
    ECOCAN.Test_S_3.fields{1}.scale = .5;
    ECOCAN.Test_S_3.fields{1}.offset = -10;

    ECOCAN.Test_S_3.fields{2}.name = 'Test_S162';
    ECOCAN.Test_S_3.fields{2}.units = '';
    ECOCAN.Test_S_3.fields{2}.start_bit = 48;
    ECOCAN.Test_S_3.fields{2}.bit_length = 16;
    ECOCAN.Test_S_3.fields{2}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.Test_S_3.fields{2}.data_type = 'SIGNED';
    ECOCAN.Test_S_3.fields{2}.scale = .5;
    ECOCAN.Test_S_3.fields{2}.offset = 0;

    ECOCAN.Test_S_3.fields{3}.name = 'Test_S24';
    ECOCAN.Test_S_3.fields{3}.units = '';
    ECOCAN.Test_S_3.fields{3}.start_bit = 16;
    ECOCAN.Test_S_3.fields{3}.bit_length = 24;
    ECOCAN.Test_S_3.fields{3}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.Test_S_3.fields{3}.data_type = 'SIGNED';
    ECOCAN.Test_S_3.fields{3}.scale = 2;
    ECOCAN.Test_S_3.fields{3}.offset = 1;

    ECOCAN.Test_S_3.fields{4}.name = 'Test_S12';
    ECOCAN.Test_S_3.fields{4}.units = '';
    ECOCAN.Test_S_3.fields{4}.start_bit = 0;
    ECOCAN.Test_S_3.fields{4}.bit_length = 12;
    ECOCAN.Test_S_3.fields{4}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.Test_S_3.fields{4}.data_type = 'SIGNED';
    ECOCAN.Test_S_3.fields{4}.scale = .5;
    ECOCAN.Test_S_3.fields{4}.offset = 1;


%%
%Network Node:HCU
%Message Name:Test_S_2
%Message Number:2
case 'Test_S_2'
    ECOCAN.Test_S_2 = struct;
    ECOCAN.Test_S_2 .name = 'Test_S_2';
    ECOCAN.Test_S_2.description = 'Test_S_2';
    ECOCAN.Test_S_2.protocol  = 'ECOCAN';
    ECOCAN.Test_S_2.id = hex2dec('3000');
    ECOCAN.Test_S_2.idext = 'EXTENDED';
    ECOCAN.Test_S_2.payload_size =8;
    ECOCAN.Test_S_2.interval =-1;

    ECOCAN.Test_S_2.fields{1}.name = 'Test_U8';
    ECOCAN.Test_S_2.fields{1}.units = '';
    ECOCAN.Test_S_2.fields{1}.start_bit = 40;
    ECOCAN.Test_S_2.fields{1}.bit_length = 8;
    ECOCAN.Test_S_2.fields{1}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.Test_S_2.fields{1}.data_type = 'UNSIGNED';
    ECOCAN.Test_S_2.fields{1}.scale = -.5;
    ECOCAN.Test_S_2.fields{1}.offset = -10;

    ECOCAN.Test_S_2.fields{2}.name = 'Test_S16';
    ECOCAN.Test_S_2.fields{2}.units = '';
    ECOCAN.Test_S_2.fields{2}.start_bit = 48;
    ECOCAN.Test_S_2.fields{2}.bit_length = 16;
    ECOCAN.Test_S_2.fields{2}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.Test_S_2.fields{2}.data_type = 'SIGNED';
    ECOCAN.Test_S_2.fields{2}.scale = -.5;
    ECOCAN.Test_S_2.fields{2}.offset = 0;

    ECOCAN.Test_S_2.fields{3}.name = 'Test_S24';
    ECOCAN.Test_S_2.fields{3}.units = '';
    ECOCAN.Test_S_2.fields{3}.start_bit = 16;
    ECOCAN.Test_S_2.fields{3}.bit_length = 24;
    ECOCAN.Test_S_2.fields{3}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.Test_S_2.fields{3}.data_type = 'SIGNED';
    ECOCAN.Test_S_2.fields{3}.scale = 2;
    ECOCAN.Test_S_2.fields{3}.offset = 1;

    ECOCAN.Test_S_2.fields{4}.name = 'Test_S12';
    ECOCAN.Test_S_2.fields{4}.units = '';
    ECOCAN.Test_S_2.fields{4}.start_bit = 0;
    ECOCAN.Test_S_2.fields{4}.bit_length = 12;
    ECOCAN.Test_S_2.fields{4}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.Test_S_2.fields{4}.data_type = 'SIGNED';
    ECOCAN.Test_S_2.fields{4}.scale = .5;
    ECOCAN.Test_S_2.fields{4}.offset = 1;
