function msg = EcoCanM_Demo_T(msgname,type)
  if(255==type)
  msg = struct;
  msg.num=11;
...
case 'MCU_STATUS_1'
    ...
    ECOCAN.MCU_STATUS_1.fields{2}.start_bit = 300;
    ECOCAN.MCU_STATUS_1.fields{2}.bit_length = 8;
    ...
    ECOCAN.MCU_STATUS_1.fields{3}.start_bit = 170;
    ...
    ECOCAN.MCU_STATUS_1.fields{4}.start_bit = 85;
    ECOCAN.MCU_STATUS_1.fields{4}.bit_length = 16;
